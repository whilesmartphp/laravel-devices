...
class DevicesTest extends TestCase
{
    ...
    public function test_api_user_can_add_a_device()
    {
        ...
        $response = $this->actingAs($user)->postJson('/devices', [
            'name' => 'test',
            'type' => 'mobile',
    ...
    public function test_api_user_can_update_their_device()
    {
        ...
        $response = $this->actingAs($user)->putJson('/devices/'.$device_id, [
            'name' => 'test',
            'type' => 'mobile',
    ...
    public function test_api_user_should_update_only_their_device()
    {
        ...
        $response = $this->actingAs($user1)->postJson('/devices', [
            'name' => 'test',
            'type' => 'mobile',
            'token' => 'qwertyuiopasdfghjklzxcvbnm',
        ]);
        ...
        $device_id = $response['data']['id'];
        $response = $this->actingAs($user2)->putJson('/devices'.$device_id, [
            'name' => 'test',
            'type' => 'mobile',
            'token' => 'mnbvcxzlkjhgfdsapoiuytrewq',
        ]);
    ...
    public function test_api_user_should_delete_only_their_device()
    {
        ...
        $device_id = $response['data']['id'];
        $response = $this->actingAs($user2)->delete('/devices'.$device_id);
    ...
    public function test_api_user_can_delete_a_device()
    {
        ...
        $device_id = $response['data']['id'];
        $response = $this->actingAs($user)->delete('/devices/'.$device_id);
